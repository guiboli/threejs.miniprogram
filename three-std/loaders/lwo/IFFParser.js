...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('./LWO2Parser.js'), require('./LWO3Parser.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', './LWO2Parser', './LWO3Parser'], factory) :
...
})(this, (function (exports, three, LWO2Parser_js, LWO3Parser_js) { 'use strict';
	...
	IFFParser.prototype = {
	  ...
	  parse: function (buffer) {
	    ...
	    if (this.tree.format === 'LWO2') {
	      this.parser = new LWO2Parser_js.LWO2Parser(this);

	      while (!this.reader.endOfFile()) this.parser.parseBlock();
	    } else if (this.tree.format === 'LWO3') {
	      this.parser = new LWO3Parser_js.LWO3Parser(this);
