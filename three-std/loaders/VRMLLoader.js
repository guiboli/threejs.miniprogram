...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', 'three', '../libs/chevrotain.module.min'], factory) :
...
})(this, (function (exports, three, chevrotain) { 'use strict';

	function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

	var chevrotain__default = /*#__PURE__*/_interopDefaultLegacy(chevrotain);

	class VRMLLoader extends three.Loader {
	  constructor(manager) {
	    super(manager); // dependency check

	    if (typeof chevrotain__default["default"] === 'undefined') {
	  ...
	  parse(data, path) {
	    ...
	    function createTokens() {
	      const createToken = chevrotain__default["default"].createToken; // eslint-disable-line no-undef
	      ...
	      const Comment = createToken({
	        name: 'Comment',
	        pattern: /#.*/,
	        group: chevrotain__default["default"].Lexer.SKIPPED // eslint-disable-line no-undef
	...
	class VRMLLexer {
	  constructor(tokens) {
	    this.lexer = new chevrotain__default["default"].Lexer(tokens); // eslint-disable-line no-undef
	  }
	...
	const CstParser = chevrotain__default["default"].CstParser; // eslint-disable-line no-undef
