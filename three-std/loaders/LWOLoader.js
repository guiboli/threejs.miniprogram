...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('./lwo/IFFParser.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', './lwo/IFFParser'], factory) :
...
})(this, (function (exports, three, IFFParser_js) { 'use strict';
	...
	class LWOLoader extends three.Loader {
	  ...
	  parse(iffBuffer, path, modelName) {
	    _lwoTree = new IFFParser_js.IFFParser().parse(iffBuffer); // console.log( 'lwoTree', lwoTree );
