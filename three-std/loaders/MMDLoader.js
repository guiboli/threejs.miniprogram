...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('../shaders/MMDToonShader.js'), require('./TGALoader.js'), require('../libs/mmdparser.module.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '../shaders/MMDToonShader', './TGALoader', '../libs/mmdparser.module'], factory) :
...
})(this, (function (exports, three, MMDToonShader_js, TGALoader_js, mmdparser_module_js) { 'use strict';
	...
	class MMDLoader extends three.Loader {
	  ...
	  _getParser() {
	    if (this.parser === null) {
	      ...
	      this.parser = new mmdparser_module_js.MMDParser.Parser(); // eslint-disable-line no-undef
	    }
	...
	class MMDToonMaterial extends three.ShaderMaterial {
	  constructor(parameters) {
	    ...
	    this.lights = true;
	    this.vertexShader = MMDToonShader_js.MMDToonShader.vertexShader;
	    this.fragmentShader = MMDToonShader_js.MMDToonShader.fragmentShader;
	    this.defines = Object.assign({}, MMDToonShader_js.MMDToonShader.defines);
	    ...
	    this.uniforms = three.UniformsUtils.clone(MMDToonShader_js.MMDToonShader.uniforms); // merged from MeshToon/Phong/MatcapMaterial
