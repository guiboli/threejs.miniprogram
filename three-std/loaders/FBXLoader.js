...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('../libs/fflate.module.js'), require('../curves/NURBSCurve.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '../libs/fflate.module', '../curves/NURBSCurve'], factory) :
...
})(this, (function (exports, three, fflate, NURBSCurve_js) { 'use strict';
	  ...
	  parseSkeleton(relationships, deformerNodes) {
	    ...
	    relationships.children.forEach(function (child) {
	      ...
	      const rawBone = {
	        ...
	        indices: [],
	        weights: [],
	        transformLink: new three.Matrix4().fromArray(boneNode.TransformLink.a) // transform: new Matrix4().fromArray( boneNode.Transform.a ),
	...
	class GeometryParser {
	  ...
	  parseNurbsGeometry(geoNode) {
	    ...
	    const curve = new NURBSCurve_js.NURBSCurve(degree, knots, controlPoints, startKnot, endKnot);
	  ...
	  parseProperty(reader) {
	    ...
	    switch (type) {
	      ...
	      case 'l':
	        ...
	        if (typeof fflate__namespace === 'undefined') {
	          console.error('THREE.FBXLoader: External library fflate.min.js required.');
	        }

	        const data = fflate__namespace.unzlibSync(new Uint8Array(reader.getArrayBuffer(compressedLength))); // eslint-disable-line no-undef
