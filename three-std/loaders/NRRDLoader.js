...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('../libs/fflate.module.js'), require('../misc/Volume.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '../libs/fflate.module', '../misc/Volume'], factory) :
...
})(this, (function (exports, three, fflate, Volume_js) { 'use strict';
	...
	class NRRDLoader extends three.Loader {
	  ...
	  parse(data) {
	    ...
	    _data = _data.buffer;
	    const volume = new Volume_js.Volume();
