...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('./BufferGeometryUtils.js')) :
...
})(this, (function (exports, three, BufferGeometryUtils_js) { 'use strict';
	...
	class LDrawUtils {
	  static mergeObject(object) {
	    ...
	    for (const meshMaterialsId of meshMaterialsIds) {
	      ...
	      const mergedGeometry = BufferGeometryUtils_js.mergeBufferGeometries(meshGeometry.arr);
	    ...
	    for (const linesMaterialsId of linesMaterialsIds) {
	      ...
	      const mergedGeometry = BufferGeometryUtils_js.mergeBufferGeometries(lineGeometry.arr);
	    ...
	    for (const condLinesMaterialsId of condLinesMaterialsIds) {
	      ...
	      const mergedGeometry = BufferGeometryUtils_js.mergeBufferGeometries(condLineGeometry.arr);
