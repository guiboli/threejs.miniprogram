...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('./Pass.js'), require('../shaders/SSRShader.js'), require('../shaders/CopyShader.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', './Pass', '../shaders/SSRShader', '../shaders/CopyShader'], factory) :
...
})(this, (function (exports, three, Pass_js, SSRShader_js, CopyShader_js) { 'use strict';

	class SSRPass extends Pass_js.Pass {
	  constructor({
	    renderer,
	    scene,
	    camera,
	    ...
	    this.opacity = SSRShader_js.SSRShader.uniforms.opacity.value;
	    this.output = 0;
	    this.maxDistance = SSRShader_js.SSRShader.uniforms.maxDistance.value;
	    this.thickness = SSRShader_js.SSRShader.uniforms.thickness.value;
	    ...
	    this.blur = true;
	    this._distanceAttenuation = SSRShader_js.SSRShader.defines.DISTANCE_ATTENUATION;
	    ...
	    this._fresnel = SSRShader_js.SSRShader.defines.FRESNEL;
	    ...
	    this._infiniteThick = SSRShader_js.SSRShader.defines.INFINITE_THICK;
	    ...
	    if (SSRShader_js.SSRShader === undefined) {
	      console.error('THREE.SSRPass: The pass relies on SSRShader.');
	    }

	    this.ssrMaterial = new three.ShaderMaterial({
	      defines: Object.assign({}, SSRShader_js.SSRShader.defines, {
	        MAX_STEP: Math.sqrt(this.width * this.width + this.height * this.height)
	      }),
	      uniforms: three.UniformsUtils.clone(SSRShader_js.SSRShader.uniforms),
	      vertexShader: SSRShader_js.SSRShader.vertexShader,
	      fragmentShader: SSRShader_js.SSRShader.fragmentShader,
	    ...
	    this.blurMaterial = new three.ShaderMaterial({
	      defines: Object.assign({}, SSRShader_js.SSRBlurShader.defines),
	      uniforms: three.UniformsUtils.clone(SSRShader_js.SSRBlurShader.uniforms),
	      vertexShader: SSRShader_js.SSRBlurShader.vertexShader,
	      fragmentShader: SSRShader_js.SSRBlurShader.fragmentShader
	    });
	    ...
	    this.depthRenderMaterial = new three.ShaderMaterial({
	      defines: Object.assign({}, SSRShader_js.SSRDepthShader.defines),
	      uniforms: three.UniformsUtils.clone(SSRShader_js.SSRDepthShader.uniforms),
	      vertexShader: SSRShader_js.SSRDepthShader.vertexShader,
	      fragmentShader: SSRShader_js.SSRDepthShader.fragmentShader,
	      blending: three.NoBlending
	    });
