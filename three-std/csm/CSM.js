...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('./CSMFrustum.js'), require('./CSMShader.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', './CSMFrustum', './CSMShader'], factory) :
...
})(this, (function (exports, three, CSMFrustum_js, CSMShader_js) { 'use strict';

	const _cameraToLightMatrix = new three.Matrix4();

	const _lightSpaceFrustum = new CSMFrustum_js.CSMFrustum();
	...
	class CSM {
	  constructor(data) {
	    ...
	    this.fade = false;
	    this.mainFrustum = new CSMFrustum_js.CSMFrustum();
	    this.frustums = [];
	    this.breaks = [];
	    this.lights = [];
	  ...
	  injectInclude() {
	    three.ShaderChunk.lights_fragment_begin = CSMShader_js.CSMShader.lights_fragment_begin;
	    three.ShaderChunk.lights_pars_begin = CSMShader_js.CSMShader.lights_pars_begin;
	  }
