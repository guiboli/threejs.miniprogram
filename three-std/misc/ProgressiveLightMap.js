...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('../libs/potpack.module.js')) :
	typeof define === 'function' && define.amd ? define(['exports', 'three', '../libs/potpack.module'], factory) :
...
})(this, (function (exports, THREE, potpack_module_js) { 'use strict';
	...
	class ProgressiveLightMap {
	  constructor(renderer, res = 1024) {
	    ...
	    this.tinyTarget = new THREE__namespace.WebGLRenderTarget(1, 1);
	    this.buffer1Active = false;
	    this.firstUpdate = true;
	    this.warned = false; // Create the Progressive LightMap Texture

	    const format = /(Android|iPad|iPhone|iPod)/g.test(navigator.userAgent) ? THREE__namespace.HalfFloatType : THREE__namespace.FloatType;
	    this.progressiveLightMap1 = new THREE__namespace.WebGLRenderTarget(this.res, this.res, {
	      type: format
	    });
	    this.progressiveLightMap2 = new THREE__namespace.WebGLRenderTarget(this.res, this.res, {
	      type: format
	    }); // Inject some spicy new logic into a standard phong material

	    this.uvMat = new THREE__namespace.MeshPhongMaterial();
	    this.uvMat.uniforms = {};
	  ...
	  addObjectsToLightMap(objects) {
	    ...
	    const dimensions = potpack_module_js.potpack(this.uv_boxes);
	  ...
	  */
	  ...
	  showDebugLightmap(visible, position = undefined) {
	    ...
	    if (this.labelMesh == null) {
	      this.labelMaterial = new THREE__namespace.MeshBasicMaterial({
	        map: this.progressiveLightMap1.texture,
	        side: THREE__namespace.DoubleSide
	      });
	      this.labelPlane = new THREE__namespace.PlaneGeometry(100, 100);
	      this.labelMesh = new THREE__namespace.Mesh(this.labelPlane, this.labelMaterial);
	  ...
	  _initializeBlurPlane(res, lightMap = null) {
	    const blurMaterial = new THREE__namespace.MeshBasicMaterial();
	    ...
	    this.blurringPlane = new THREE__namespace.Mesh(new THREE__namespace.PlaneGeometry(1, 1), blurMaterial);
