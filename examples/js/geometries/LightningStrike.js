( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( '../math/SimplexNoise.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', '../math/SimplexNoise' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, SimplexNoise_js ) {
	...
	*/
	  ...
	  init( rayParameters ) {
	    ...
	    this.simplexZ = new SimplexNoise_js.SimplexNoise( this.seedGenerator ); // Temp vectors
