( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( './Pass.js' ), require( '../shaders/DigitalGlitch.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', './Pass', '../shaders/DigitalGlitch' ], factory ) :
	...
	} )( this, ( function ( exports, three, Pass_js, DigitalGlitch_js ) {

		'use strict';

		class GlitchPass extends Pass_js.Pass {

	  constructor( dt_size = 64 ) {

	    super();
	    if ( DigitalGlitch_js.DigitalGlitch === undefined ) console.error( 'THREE.GlitchPass relies on DigitalGlitch' );
	    const shader = DigitalGlitch_js.DigitalGlitch;
