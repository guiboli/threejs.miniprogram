( function () {
	...
	} )( this, ( function ( exports, three, Pass_js, CopyShader_js ) {
	...
	*/
		...
		class SSAARenderPass extends Pass_js.Pass {
	  ...
	  constructor( scene, camera, clearColor, clearAlpha ) {
	    ...
	    if ( CopyShader_js.CopyShader === undefined ) console.error( 'THREE.SSAARenderPass relies on CopyShader' );
	    ...
	    this.fsQuad = new Pass_js.FullScreenQuad( this.copyMaterial );
