( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( './SSAARenderPass.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', './SSAARenderPass' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, SSAARenderPass_js ) {
	 ...
	 */
		...
		class TAARenderPass extends SSAARenderPass_js.SSAARenderPass {
