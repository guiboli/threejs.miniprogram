( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( '../libs/mmdparser.module.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', '../libs/mmdparser.module' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, mmdparser_module_js ) {
	 ...
	 */
	  ...
	  */
	  ...
	  if ( u2sTable === undefined ) {
	    ...
	    const encoder = new mmdparser_module_js.MMDParser.CharsetEncoder(); // eslint-disable-line no-undef
