( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( '../geometries/ConvexGeometry.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', '../geometries/ConvexGeometry' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, ConvexGeometry_js ) {
	...
	*/
	  ...
	  cutByPlane( object, plane, output ) {
	    ...
	    if ( numPoints1 > 4 ) {
	      ...
	      object1 = new three.Mesh( new ConvexGeometry_js.ConvexGeometry( points1 ), object.material );
	    ...
	    if ( numPoints2 > 4 ) {
	      ...
	      object2 = new three.Mesh( new ConvexGeometry_js.ConvexGeometry( points2 ), object.material );
