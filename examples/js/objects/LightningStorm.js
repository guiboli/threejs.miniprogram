( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( '../geometries/LightningStrike.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', '../geometries/LightningStrike' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, LightningStrike_js ) {
	...
	*/
	  ...
	  constructor( stormParams = {} ) {
	    ...
	    for ( let i = 0; i < this.stormParams.maxLightnings; i ++ ) {
	      ...
	      const lightning = new LightningStrike_js.LightningStrike( LightningStrike_js.LightningStrike.copyParameters( {}, this.lightningParameters ) );
	  ...
	  update( time ) {
	    ...
	    if ( time >= this.nextLightningTime ) {
	      ...
	      if ( lightningMesh ) {
	        ...
	        const lightningParams1 = LightningStrike_js.LightningStrike.copyParameters( lightningMesh.geometry.rayParameters, this.lightningParameters );
