( function () {
	...
	( function ( global, factory ) {
		...
		typeof exports === 'object' && typeof module !== 'undefined' ? factory( exports, require( 'three' ), require( '../shaders/UnpackDepthRGBAShader.js' ) ) :
			typeof define === 'function' && define.amd ? define( [ 'exports', 'three', '../shaders/UnpackDepthRGBAShader' ], factory ) :
				( global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory( global.THREE = global.THREE || {}, global.THREE, global.THREE ) );

	} )( this, ( function ( exports, three, UnpackDepthRGBAShader_js ) {
	 ...
	 */
	  ...
	  constructor( light ) {
	    ...
	    const shader = UnpackDepthRGBAShader_js.UnpackDepthRGBAShader;
